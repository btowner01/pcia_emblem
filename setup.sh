...
# Variable list
PROD_PROJECT=pcia-dev-10242023            #GCP Project ID of the production project
STAGE_PROJECT=pcia-test-10242023           #GCP Project ID of the staging project
OPS_PROJECT=pcia-v1-10202023             #GCP Project ID of the operations project
